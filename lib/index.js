...
*   - **force** (default): interrupts everything NOW — any in-flight tool is
...
*   - **safe** (explicit only): never interrupts work. A running TOOL is left
...
/** Register the commands, the session-event listener, the service, and the state route. */
...
//#endregion
export { DEFAULT_SAFE_PAUSE_REASONING, apply, clearPaused, clearStoredState, createStateHandler, createTaskControlService, currentState, encodeSessionId, inject, markPaused, name, readStoredState, stateFilePath, stateRootDir, writeStoredState };
